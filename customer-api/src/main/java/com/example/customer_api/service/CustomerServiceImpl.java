...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerResponseDTO updateCustomer(Long id, CustomerRequestDTO requestDTO) {
        ...
        // Note: Customer code is typically immutable
    ...
    public List<CustomerResponseDTO> getCustomersByStatus(String statusStr) {
        try {
            Customer.CustomerStatus status = Customer.CustomerStatus.valueOf(statusStr.toUpperCase());
    ...
    public List<CustomerResponseDTO> advancedSearch(String name, String email, String statusStr) {
        ...
        if (statusStr != null && !statusStr.isEmpty()) {
            try {
                status = Customer.CustomerStatus.valueOf(statusStr.toUpperCase());
            } catch (IllegalArgumentException e) {
